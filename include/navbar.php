...
<nav class="navbar navbar-expand-lg navbar-light bg-danger">
	<a class="navbar-brand" href="#">
		<img src="./static/svgs/dumbell.svg" width="40" height="40" alt="" loading="lazy" />
	</a>
	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
		...
		<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
			<li class="nav-item ">
				<a class="nav-link font-weight-bold" href="./mform.php">Premium membership <span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item">
...
<script defer>
	...
	function removeEle(param) {
		cart.splice(cart.indexOf(param), 1);
		updateModalBody();
	}
