...
if (isset($_COOKIE['username'])) {
    ...
    $tierhtml = '';
    if ($tier == "G") {
        $tierhtml = "<div class='alert alert-warning mx-auto col-md-10' role='alert'><b>GOLD </b>Membership detected!!<b>10% OFF AND FREE DELIVERY (Same Day)</b></div>";
        $discount = 0.1;
    } else if ($tier == "S") {
        $tierhtml = "<div class='alert alert-secondary mx-auto col-md-10' role='alert'><b>SILVER </b>Membership detected!!<b>5% OFF AND FREE DELIVERY (Two Business Days)</b></div>";
        $discount = 0.1;
    } else if ($tier == "B") {
        $tierhtml = "<div class='alert alert-light mx-auto col-md-10' role='alert'><b>BRONZE </b>Membership detected!!<b>5% OFF your purchase</b></div>";
        $discount = 0.05;
    }
}
