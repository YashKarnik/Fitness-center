...
<body>
	...
	<img src="./static/favicon/favicon.svg" class="dead-center bg-img" alt="gg" />
	<?php if (isset($error)) : ?>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-3">
					...
					<div class="custom-control custom-radio custom-control-inline">
						<input type="radio" id="male" value="male" name="gender" class="custom-control-input" required />
				...
				<button type="submit" class="btn btn-primary btn-lg display-3 mx-auto text-center">
					Submit
				</button>
			</div>
			<a href="logIn.php" class="text-light">Already a user ? Sign in here</a><br />
		</form>
	</div>
</body>
<script>
