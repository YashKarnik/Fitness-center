	...
	<div class="container w-50 h-50 bg-danger mt-5 p-3 rounded-sm">
			...
			<form method="POST" action='<?php echo $_SERVER['PHP_SELF'];  ?>'>
				...
				<div class="form-group col-md-12 text-center">
					<label for="inputZip" class="my-2">
						<h3 id="tier-cost">Select Tier</h3>
					</label><br />
					<div class="custom-control custom-radio custom-control-inline">
						<input type="radio" id="gold" name="tier" value="gold" class="custom-control-input" required />
						<label class="custom-control-label" for="gold">Gold</label>
					</div>
					<div class="custom-control custom-radio custom-control-inline">
						<input type="radio" id="silver" name="tier" value="silver" class="custom-control-input" />
						<label class="custom-control-label" for="silver">Silver</label>
					</div>
					<div class="custom-control custom-radio custom-control-inline">
						<input type="radio" id="bronze" name="tier" class="custom-control-input" value="bronze" />
						<label class="custom-control-label" for="bronze">Bronze</label>
					</div>
				</div>
				<div class="form-group col-md-12 text-center">
					<label for="membership-duration">
						<h3 id="membership-duration-label">Set Duration</h3>
					</label>
		...
		<?php else : ?>
			...
			<h1 class='text-center'>Membership Already Active.<br>
				<span>
					<h3>Expires on <?php echo $date_expiry ?></h3>
				</span>
