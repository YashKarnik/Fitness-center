...
<body>
    ...
    <div class="container-fluid text-white">
        <h1 class='display-2  text-center'> Curls</h1>
        <p>
        ...
        <p class='text-center'>
            <iframe width="100%" height="480" src="https://www.youtube.com/embed/ykJmrZ5v0Oo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
